...
def emprestimoLivro(livroId, alunoId):
    ...
    if livroEncontrado: ##se retorna o valor verdadeiro ele segue com o emprestimo 
        ...
        if alunoEncontrado: ## se o aluno for verdadeiro ele vai finalziar o emprestimo do livro
            ...
            print("⚠️ AVISO! ALUNO NÃO CADASTRADO")
...
def devolverLivro(livroId, alunoId):
    ...
    if livroEncontrado:
        ...
        if alunoEncontrado:
            ...
            print(f"Livro {livroEncontrado['titulo']} Entregue pelo aluno(a) {alunoEncontrado['nome']} no dia {livroEncontrado["dataAtualizacao"]}")
        else:
            print("⚠️ AVISO! ALUNO NÃO CADASTRADO")
    else:
